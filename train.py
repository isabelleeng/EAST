...
parser.add_argument('--max_epochs', type=int, default=35) # maximum number of epochs
...
parser.add_argument('--restore_model', type=str, default='tmp\\model\\weights-25.h5')
...
def main(argv=None):
    ...
    # parallel_model.load_weights(FLAGS.restore_model)

    history = parallel_model.fit_generator(train_data_generator, epochs=FLAGS.max_epochs, steps_per_epoch=train_samples_count/FLAGS.batch_size, workers=FLAGS.nb_workers, max_queue_size=10, callbacks=callbacks, verbose=1, initial_epoch=25)
