...
def detect(frame, score_map, geo_map, timer, score_map_thresh=0.99, nms_thres=0.3):
    '''
...
def main(argv=None):
    ...
    while True:
        ...
        boxes, timer = detect(FLAGS.frame_no, score_map=score_map, geo_map=geo_map, timer=timer)
